...
from music_app.views import MusicTrackList, MusicTrackDetail, MusicGenreList, MusicGenreDetail, MusicTrackListForm, MusicGenreListForm,MusicTrackUpdate
...
urlpatterns = [
    ...
    url(r'^tracks/edit/(?P<track_id>[0-9]+)/$', MusicTrackUpdate.as_view()),
